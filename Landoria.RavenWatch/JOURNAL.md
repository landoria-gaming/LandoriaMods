...
| `GROUND_ITEM_OBSERVED` | A network-loaded ground item appears | Item, network owner, synchronized spawn time, position, velocity and nearby players. Locally created items are excluded. |
